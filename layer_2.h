...
LayoutKey layout2[rowsCount][columnsCount] = {
  ...
  {{KEY_NULL},   {KEY_AT},           {KEY_SLASH},   {KEY_DOLLAR},     {KEY_NULL},    {KEY_DEGREES},  {KEY_MINUS}, {KEY_NULL},      {KEY_NULL},{KEY_EQUAL},{KEY_NULL},   {KEY_NULL},{KEY_ENTER},{MOUSE_LCLICK},{KEY_NULL}},
  ...
  {{KEY_RELEASE},{KEY_NULL},         {KEY_NULL},    {KEY_NULL},       {LAYER_2},     {KEY_ENTER},    {KEY_DELETE},{LAYER_3},       {KEY_NULL},{KEY_NULL}, {KEY_NULL},   {KEY_NULL},{KEY_NULL}, {KEY_NULL},    {KEY_NULL}}
};
